pipeline {
    ...
    parameters {
         ...
         string(name:'war_file',defaultValue:"\"C:/Program Files (x86)/Jenkins/workspace/FullyAutomated/webapp/target/*.war\"")
        ...
        stage ('Deployments'){
            parallel{
                stage ('Deploy to Staging'){
                    steps {
                        bat "echo y|pscp -i ${params.tomcat_stage}  ${params.war_file} ec2-user@${params.tomcat_dev}:/var/lib/tomcat8/webapps"
}
                }
